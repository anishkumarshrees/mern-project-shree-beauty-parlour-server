...
router.route("/:productId").post(userMiddleware.isUserLoggedIn,userMiddleware.accessTo(Role.Customer),CartController.deleteMyCartItems).patch(userMiddleware.isUserLoggedIn,userMiddleware.accessTo(Role.Customer),CartController.updateCartItem)
